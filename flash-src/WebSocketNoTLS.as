...
public class WebSocketNoTLS extends EventDispatcher {
  ...
  private var main:WebSocketMainNoTLS;
  ...
  public function WebSocketNoTLS(
      main:WebSocketMainNoTLS, url:String, protocol:String,
